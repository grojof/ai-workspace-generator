...
metadata:
  ...
  version: "1.0"
---
## sdd-code-maintenance — propagate spec changes into code
...
- Reuse `sdd-code-generation`'s patterns for the add/modify cases; keep the layer ordering.
- When an operation **signature** changes, hand off to `sdd-test-generation` to re-derive its tests.
