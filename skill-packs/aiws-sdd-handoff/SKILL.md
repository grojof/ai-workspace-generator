...
metadata:
  ...
  version: "1.0"
---
## aiws-sdd-handoff — package for IT review

Package a finished project so the IT reviewer can audit it. **Refuse** if a recent `aiws-sdd-self-review` verdict
