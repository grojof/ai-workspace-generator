...
metadata:
  ...
  version: "1.0"
---
## aiws-sdd-test-generation — spec §5 Tests → a real suite
...
assertions). Record the run in `{{paths.changes}}/<change>/`. Hand off to `aiws-sdd-self-review`.
