...
metadata:
  ...
  version: "1.0"
---
## aiws-sdd-self-review — pre-handoff validation gauntlet
...
- **Cross-profile:** the `aiws-sdd-spec-schema` checklist passes; forbidden-pattern scan; **SDD store consistency**
...
Record the verdict in `{{paths.status}}/PROJECT-STATE.md` and the change-folder. Hand off to `aiws-sdd-handoff`.
