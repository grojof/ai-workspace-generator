...
metadata:
  ...
  version: "1.0"
---
## aiws-sdd-spec-capture — guided interview → REASONS spec
...
partial answers in the change-folder so a pause is safe. Schema reference: the `aiws-sdd-spec-schema` skill.
...
5. Validate against the full `aiws-sdd-spec-schema` checklist before writing. Never save an invalid spec.
