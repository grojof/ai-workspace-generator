...
metadata:
  ...
  version: "1.0"
---
## aiws-sdd-spec-schema — REASONS Canvas
...
generated only from `user-reviewed` or later. The `aiws-sdd-spec-review` skill drives every transition and refuses
